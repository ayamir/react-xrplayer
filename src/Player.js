...
import {enableEffectContainer, setEffectData, setGlobalMuted, setGlobalVolume} from './redux/player.redux';
...
class XRPlayer extends Component {
	...
	render() {
		let {
			width, height, is_full_screen = false,
			is_effect_displaying, effect_data
		} = this.props;
